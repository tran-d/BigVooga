...
public class SpriteCreatorManager extends TabPane {
	...
	public SpriteCreatorManager(AuthoringEnvironmentManager AEM, Stage currentStage) {
		myAEM = AEM;
	...
	private void createTab(int tabCount, DraggableGrid w) { // ?
		...
		tabMap.bind(
				Bindings.concat(DisplayLanguage.createStringBinding(TAB_TAG)).concat(" " + Integer.toString(tabCount)));
