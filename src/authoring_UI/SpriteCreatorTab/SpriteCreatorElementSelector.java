...
public class SpriteCreatorElementSelector extends GameElementSelector {
	...
	protected SpriteCreatorElementSelector(SpriteGridHandler spriteGridHandler, AuthoringEnvironmentManager AEM, String type) {
	...
	protected void addSpriteGridHandlerFunctionality(AbstractSpriteObject ASO){
		ASO.setOnMouseClicked(e->{
			((SpriteCreatorGridManager)this.mySpriteGridHandler.getDraggableGrid().getActiveGrid()).setSpriteToCoverEntireGrid(ASO.newCopy());
		});
	}
