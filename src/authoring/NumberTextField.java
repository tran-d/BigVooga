...
/**
 * Open source code for a custom NumberTextField to go align with a NumberSpinner that will modify
 * the value of the number. No code was written -- this code is used as is with all credit gone to Thomas Bolz.
 * 
